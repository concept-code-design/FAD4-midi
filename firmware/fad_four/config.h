...
__code uint8_t DevDesc[] = {    
    ...
    0x09,0x12,0xFF,0xDF, /* VID PID bString (see https://pid.codes/1209/DF03/)*/
...
__code uint8_t Prod_Des[]={                                // Produce String Descriptor
    0x1A,0x03,'F',0x00,'a',0x00,'d',0x00,'-',0x00,'f',0x00,'o',0x00,'u',0x00,'r',0x00,' ',0x00,'v',0x00,'1',0x00};
__code uint16_t Prod_DesLen = sizeof(Prod_Des);

__code uint8_t Manuf_Des[]={
    0x1E,0x03,
    'C',0x00,'o',0x00,'n',0x00,'c',0x00,'e',0x00,'p',0x00,'t',0x00,' ',0x00,'&',0x00,' ',0x00,'C',0x00,'o',0x00,'d',0x00,'e',0x00};
